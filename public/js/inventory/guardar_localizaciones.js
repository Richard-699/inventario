$(document).ready(function () {
    ...
    document.getElementById('formAgregarLocalizacion').addEventListener('submit', async function (e) {
        e.preventDefault();
        mostrarCarga();

        const form = document.getElementById('formAgregarLocalizacion');
        ...
        const action = 'guardar_localizacion';
        ...
        try {
            ...
            if (resultado.success) {
                notification('success', 'Se registró la localización.', 2000);
